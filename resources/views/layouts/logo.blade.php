<div id="logo_be" style="width: 100vw; height: 100vh; background-color: #121212; position: fixed; z-index: 5000000;">
    <div class="opacity-0">
        <img src="img/logo/logo_be.svg" alt="" style="max-height: 80vh; max-width: 80vw; padding: 5rem;" class="position-absolute top-50 start-50 translate-middle rounded-circle">
