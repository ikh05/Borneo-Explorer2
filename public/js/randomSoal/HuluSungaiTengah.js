Soal.HuluSungaiTengah = {
    ...
    statistika: ()=>{ //%!/(3!2!) = 5.4/2 = 10 macam
        ...
        let randomEntries = '';
        console.log(typeof (HuluSungaiTengah.random_statistika));
        ...
        } while (HuluSungaiTengah.random_statistika.array_in_array(randomEntries));
        console.log('statistika selesai_random');

        // simpan ke daftar 5 terakhir
        HuluSungaiTengah.random_statistika.lastPush(randomEntries);
    ...
    barisan_dan_deret: function() {
        ...
        } while (HuluSungaiTengah.random_barisan_dan_deret.array_in_array([a, r, n]));
        console.log('masukkan ke array record');
        HuluSungaiTengah.random_barisan_dan_deret.lastPush([a, r, n]);
