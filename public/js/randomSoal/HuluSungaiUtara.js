window.HuluSungaiUtara = {
    ...
    statistika: ()=>{ //%!/(3!2!) = 5.4/2 = 10 macam
        ...
        let randomEntries = '';
        console.log(typeof (HuluSungaiUtara.random_statistika));
        ...
        } while (HuluSungaiUtara.random_statistika.array_in_array(randomEntries));
        console.log('statistika selesai_random');

        // simpan ke daftar 5 terakhir
        HuluSungaiUtara.random_statistika.lastPush(randomEntries);
    ...
    barisan_dan_deret: function() {
        ...
        } while (HuluSungaiUtara.random_barisan_dan_deret.array_in_array([a, r, n]));
        console.log('masukkan ke array record');
        HuluSungaiUtara.random_barisan_dan_deret.lastPush([a, r, n]);
